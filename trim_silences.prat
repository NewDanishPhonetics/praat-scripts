# Praat has a command to remove silence from a sound file. This is just a demonstration on how to use it.
# Select a sound in the objects list and run this command from a Praat script:
